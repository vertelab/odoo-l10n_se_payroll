...
@tagged('at_install', 'l10n_se_payroll_twenty_six', 'june')
class TestPayslipJune(TransactionCase):
    ## Test 1
    def test_asse_net(self):   

        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_asse_06')
        ...
        self.assertAlmostEqual(net_line.total, 21557.0, msg=f"Fel nettolön för Asse! Fick: {net_line.total}, förväntat: 21557.0.")
    ...
    def test_frans_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_frans_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Frans.")
        self.assertAlmostEqual(net_line.total, 24690.0, msg=f"Fel nettolön för Frans! Fick: {net_line.total}, förväntat: 24690.0.")
    ...
    def test_doris_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_doris_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Doris.")
        self.assertAlmostEqual(net_line.total, 14705.0, msg=f"Fel nettolön för Doris! Fick: {net_line.total}, förväntat: 14705.0.")
    ...
    def test_camilla_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_camilla_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Camilla.")
        self.assertAlmostEqual(net_line.total, 25061.0, msg=f"Fel nettolön för Camilla! Fick: {net_line.total}, förväntat: 25061.0.")
    ...
    def test_gustav_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_gustav_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Gustav.")
        self.assertAlmostEqual(net_line.total, 7298.0, msg=f"Fel nettolön för Gustav! Fick: {net_line.total}, förväntat: 7298.0.")
    ...
    def test_helmer_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_helmer_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Helmer.")
        self.assertAlmostEqual(net_line.total, 19048.0, msg=f"Fel nettolön för Helmer! Fick: {net_line.total}, förväntat: 19048.0.")
    ...
    def test_karin_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_karin_06')

        net_line = payslip.line_ids.filtered(lambda l: l.code == 'nl')

        self.assertTrue(net_line, "Kunde inte hitta fältet 'nl' (Nettolön) för Karin.")
        self.assertAlmostEqual(net_line.total, 14516.0, msg=f"Fel nettolön för Karin! Fick: {net_line.total}, förväntat: 14516.0.")
