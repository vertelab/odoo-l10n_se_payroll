...
class TestPayslipJune(TransactionCase):
    ...
    def test_asse_net(self):   
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_asse_06')
    ...
    def test_frans_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_frans_06')
    ...
    def test_doris_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_doris_06')
    ...
    def test_camilla_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_camilla_06')
    ...
    def test_gustav_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_gustav_06')
    ...
    def test_helmer_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_helmer_06')
    ...
    def test_karin_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_26.hr_payslip_karin_06')
