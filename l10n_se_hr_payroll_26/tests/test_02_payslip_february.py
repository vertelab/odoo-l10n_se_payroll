...
class TestPayslipFebruary(TransactionCase):
    ...
    def test_asse_net(self):   
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_asse_02')
    ...
    def test_frans_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_frans_02')
    ...
    def test_doris_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_doris_02')
    ...
    def test_camilla_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_camilla_02')
    ...
    def test_gustav_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_gustav_02')
    ...
    def test_helmer_net(self):
        ...
        payslip = self.env.ref('l10n_se_hr_payroll_twenty_six.hr_payslip_helmer_02')
