...
We create test data to seven employees, to use while developing our own code. To validare that it all turns out correct.
    ...
    'data':[
        ...
        'data/01_data_asse.xml',
        'data/02_data_frans.xml',
        'data/03_data_doris.xml',
        'data/04_data_camilla.xml',
        'data/05_data_gustav.xml',
        'data/06_data_helmer.xml',
        'data/07_data_karin.xml',
    ],
    'auto_install': True,
    'installable': True,
}
