...
class TestPayslipJanuary(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.asse_kar = self.create_leave(cls.employee_asse,'sjk_kar',"2022-05-09","2022-05-13",5.0)
        cls.asse_kar.action_approve()
        cls.asse_kar = self.create_leave(cls.employee_asse,'sjk_kar',"2022-05-16","2022-05-18",3.0)
        cls.asse_kar.action_approve()
        ...
        cls.helmer_kar = self.create_leave(cls.employee_helmer,'sjk_kar',"2022-05-19","2022-05-20",2.0)
        cls.helmer_kar.action_approve()
        cls.helmer_kar = self.create_leave(cls.employee_helmer,'sjk_kar',"2022-05-27","2022-05-27",1.0)
        cls.helmer_kar.action_approve()
        cls.helmer_kar = self.create_leave(cls.employee_helmer,'sjk_kar',"2022-05-30","2022-05-30",1.0)
        cls.helmer_kar.action_approve()
