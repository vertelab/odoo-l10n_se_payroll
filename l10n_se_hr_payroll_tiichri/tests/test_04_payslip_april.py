...
class TestPayslipApril(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_kar" ,"2022-04-04","2022-04-04",1)
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_214" ,"2022-04-05","2022-04-06",2)
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_kar" ,"2022-04-12","2022-04-12",1)
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_214" ,"2022-04-13","2022-04-13",1)
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_kar" ,"2022-04-26","2022-04-26",1)
        cls.frans_kar = cls._create_leave(cls.employee_frans.id, "sjk_214" ,"2022-04-27","2022-04-28",2)
        ...
        cls.helmer_kar = cls._create_leave(cls.employee_helmer.id, "sjk_kar" ,"2022-04-01","2022-04-01",1)
        cls.helmer_kar = cls._create_leave(cls.employee_helmer.id, "sjk_214" ,"2022-04-04","2022-04-08",5)
        cls.helmer_kar = cls._create_leave(cls.employee_helmer.id, "sjk_214" ,"2022-04-11","2022-04-14",4)
        cls.helmer_kar = cls._create_leave(cls.employee_helmer.id, "sjk_214" ,"2022-04-19","2022-04-20",2)
